            ...
            return (
                <div className="card-before card border-3 border-light bg-black" style={{width: '9rem'}}>
                    ...
                    <div className="bg-dark text-secondary panel-footer text-center">
                        ...
                        <span className='float-start'> attack :     {this.props.data.info.attack}     </span><br></br>
                        <span className='float-start'> defense :    {this.props.data.info.defense}    </span><br></br>
                        <span className='float-start'> difficulty : {this.props.data.info.difficulty} </span><br></br>
